...
export interface TemplateBundle {
  svmTemplates: Template[];
  evmTemplates: Template[];
}

// Shared card shape used by the UI components
...
export const svmTemplates: Template[] = [
  {
    id: 'svm-spl-token',
    name: 'SPL Token',
    icon: '🪙',
...
export const evmTemplates: Template[] = [
  {
    id: 'evm-erc20',
    name: 'ERC-20 Token',
    icon: '💠',
...
const all: TemplateBundle = {
  svmTemplates,
  evmTemplates
};

export const SOLANA_TEMPLATES: TemplateCard[] = svmTemplates.map((t) => ({
  id: t.id,
  title: t.name,
...
export const ETHEREUM_TEMPLATES: TemplateCard[] = evmTemplates.map((t) => ({
  id: t.id,
  title: t.name,
  description: t.description,
  emoji: t.icon,
...
// Compatibility aliases for existing imports in the UI
// Some components import SOLANA_TEMPLATES / ETHEREUM_TEMPLATES
// These aliases map to the actual template arrays defined above.
export const SOLANA_TEMPLATES = svmTemplates;
export const ETHEREUM_TEMPLATES = evmTemplates;
