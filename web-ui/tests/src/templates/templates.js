// CommonJS data module for tests: 5 SVM and 5 EVM templates
module.exports = {
  svm: [
    {
      id: 'svm-spl-token',
  ...
  evm: [
    ...
    },
    {
      ...
      prompt: 'Create a Solidity governance contract using OpenZeppelin Governor. Include propose, vote, queue, and execute. Voting period 1 week, quorum 4%.'.replace(/\.$/, '')
    }
  ]
};
